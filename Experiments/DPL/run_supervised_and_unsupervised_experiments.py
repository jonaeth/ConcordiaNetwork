...
def main(opt):
    ...
    concordia.fit_semisupervised(train_data_loader_unlabeled, train_data_loader_labeled, valid_data_loader, epochs=20, metrics={'f1_score': f1_score,
    ...
    concordia.fit_unsupervised(train_data_loader_unlabeled, valid_data_loader, epochs=20, metrics={'f1_score': f1_score,
                                                                                         'accuracy_score': accuracy_score,
                                                                                         'recall_score': recall_score,
                                                                                         'precision_score': precision_score})
