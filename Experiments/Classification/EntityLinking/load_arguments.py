...
def load_arguments():
    ...
    parser.add_argument('--word_embedding', type=str,
                        default='Experiments/EntityLinking/data/pubmed_parsed/embedding_vec_gene.pkl',
    ...
    parser.add_argument('--dataroot', type=str,
                        default='Experiments/EntityLinking/data/pubmed_parsed',
                        help='the data root')
    ...
    parser.add_argument('--vocab_path', type=str,
                        default="Experiments/EntityLinking/data/pubmed_parsed/vocab_gene.pkl",
                        help='the vocab path')
    ...
    parser.add_argument('--save_path', type=str,
                        default='Experiments/EntityLinking/model/model.pkl',
                        help='the current entity type we are trained on')
    ...
    parser.add_argument('--gene_key', type=str,
                        default='Experiments/EntityLinking/data/gene_key.pkl',
                        help='display the confidence for each prediction')
